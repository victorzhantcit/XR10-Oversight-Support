...
namespace MRTK.Extensions
{
    ...
    {
        private zhSimplify2Traditional language = new zhSimplify2Traditional();
        ...
        private void DictationSubsystem_Recognized(DictationResultEventArgs obj)
        {
            ...
            OnSpeechRecognized.Invoke(language.convertS2T(obj.Result));
        }
        ...
        private void DictationSubsystem_Recognizing(DictationResultEventArgs obj)
        {
            ...
            OnSpeechRecognizing.Invoke(language.convertS2T(obj.Result));
        }
